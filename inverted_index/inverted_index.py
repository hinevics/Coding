...
parser.add_argument(
    ...
    help='Create an inverted index file. '
         'Please, specify the path to the file with documents, '
         'the file of stop words and'
         f' the path where to save the result (defult={default_links["link_inverted_index"]})')
